...
public class RecipeRegistry 
{
	...
	public void registerRecipes()
	{
		...
		GameRegistry.addRecipe(new ItemStack(IdMap.blockThermalMachines, 1, 0), new Object[] {"XBX", "SCO", "XFX", 'X', Item.ingotIron, 'B', new ItemStack(IdMap.itemCraftingItems, 1, 0), 'S', new ItemStack(IdMap.itemCraftingItems, 1, 6), 'C', new ItemStack(IdMap.itemCraftingItems, 1, 2), 'O', new ItemStack(IdMap.itemCraftingItems, 1, 4), 'F', Block.furnaceIdle});
		GameRegistry.addRecipe(new ItemStack(IdMap.blockThermalMachines, 1, 1), new Object[] {"XXX", "TCT", "XFX", 'X', Item.ingotIron, 'T', new ItemStack(IdMap.itemCraftingItems, 1, 3), 'C', new ItemStack(IdMap.itemCraftingItems, 1, 2), 'F', Block.furnaceIdle});
		GameRegistry.addRecipe(new ItemStack(IdMap.blockThermalMachines, 1, 2), new Object[] {"XXX", "CEO", "XFX", 'X', Item.ingotIron, 'C', new ItemStack(IdMap.itemCraftingItems, 1, 2), 'E', new ItemStack(IdMap.itemCraftingItems, 1, 6), 'O', new ItemStack(IdMap.itemCraftingItems, 1, 4), 'F', Block.furnaceIdle});
