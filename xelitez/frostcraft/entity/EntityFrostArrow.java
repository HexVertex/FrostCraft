...
public class EntityFrostArrow extends Entity implements IProjectile
{
    ...
    /** 1 if the player can pick up the frostArrow */
    public int canBePickedUp = 0;

    /** Seems to be some sort of timer for animating an frostArrow. */
    public int frostArrowShake = 0;

    /** The owner of this frostArrow. */
    ...
    public EntityFrostArrow(World par1World)
    {
        super(par1World);
    ...
    public EntityFrostArrow(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    /**
     * Similar to setFrostArrowHeading, it's point the throwable entity to a x, y, z direction.
     */
    ...
    public void onUpdate()
    {
        ...
        if (this.frostArrowShake > 0)
        {
            --this.frostArrowShake;
        }
        if (this.inGround)
        {
        ...
        if(!worldObj.isRemote && this.tickCounter == 1)
        {
        	...
        	PacketSendManagerServer.sendArrowData(this);
        	tickCounter = 2;
        }
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setByte("shake", (byte)this.frostArrowShake);
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        this.frostArrowShake = par1NBTTagCompound.getByte("shake") & 255;
    ...
    {
        if (!this.worldObj.isRemote && this.inGround && this.frostArrowShake <= 0)
        {
    ...
    /**
     * Sets the amount of knockback the frostArrow applies when it hits a mob.
     */
    ...
    /**
     * Whether the frostArrow has a stream of critical hit particles flying behind it.
     */
