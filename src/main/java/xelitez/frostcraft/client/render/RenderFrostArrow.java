...
public class RenderFrostArrow extends Render
{
    ...
    public void renderFrostArrow(EntityFrostArrow par1EntityFrostArrow, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        GL11.glRotatef(par1EntityFrostArrow.prevRotationPitch + (par1EntityFrostArrow.rotationPitch - par1EntityFrostArrow.prevRotationPitch) * par9, 0.0F, 0.0F, 1.0F);
        ...
        float var21 = (float)par1EntityFrostArrow.frostArrowShake - par9;
