...
public class TileEntityFreezer extends TileEntityThermalMachines implements ISidedInventory
{
    ...
    public void freezeItem()
    {
        if (this.canFreeze())
        {
            ...
            if(this.items[0].getItem().getContainerItem(items[0]) != null)
            {
            	if(this.items[2] == null)
            	{
            		this.items[2] = this.items[0].getItem().getContainerItem(items[0]).copy();
            	}
            	else if(this.items[0].getItem().getContainerItem(items[0]).isItemEqual(this.items[2]) && this.items[2].stackSize + 1 < this.items[2].getMaxStackSize())
            	{
            		this.items[2].stackSize += this.items[0].getItem().getContainerItem(this.items[0]).stackSize;
            	}
            }
    ...
    private boolean canFreeze()
    {
        ...
        else
        {
            ...
            if (this.items[1] == null && (this.items[0].getItem().getContainerItem(items[0]) == null || (this.items[2] == null || (this.items[2].isItemEqual(var1) && this.items[2].stackSize + 1 < this.items[2].getMaxStackSize())))) return true;
