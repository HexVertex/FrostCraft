...
public class BlockThermalMachines extends BlockContainer implements IConnect
{
    ...
    public void onBlockAdded(World par1World, int par2, int par3, int par4)
    {
        ...
        {
        	TileEntityThermalPump te = (TileEntityThermalPump)par1World.getTileEntity(par2, par3, par4);
    ...
    {
    	TileEntityThermalMachines var7 = (TileEntityThermalMachines)par1World.getTileEntity(par2, par3, par4);
    ...
    {
        if (!par1World.isRemote && par1World.getBlockMetadata(par2, par3, par4) == 0 && ((TileEntityThermalPump)par1World.getTileEntity(par2, par3, par4)).isActive && par1World.isBlockIndirectlyGettingPowered(par2, par3, par4))
        {
            ((TileEntityThermalPump)par1World.getTileEntity(par2, par3, par4)).setActive(false);
        }
    }
