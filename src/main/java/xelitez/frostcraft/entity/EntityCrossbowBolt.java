...
public class EntityCrossbowBolt extends Entity implements IProjectile
{
    ...
    /** 1 if the player can pick up the crossbowBolt */
    public int canBePickedUp = 0;

    /** Seems to be some sort of timer for animating an crossbowBolt. */
    public int crossbowBoltShake = 0;

    /** The owner of this crossbowBolt. */
    public Entity shootingEntity;
    private int ticksInGround;
    private int ticksInAir = 0;
    private double damage = 2.0D;

    /** The amount of knockback an crossbowBolt applies when it hits a mob. */
    ...
    /**
     * Similar to setcrossbowBoltHeading, it's point the throwable entity to a x, y, z direction.
     */
    ...
    public void onUpdate()
    {
        ...
        if (this.crossbowBoltShake > 0)
        {
            --this.crossbowBoltShake;
        }
        if (this.inGround)
        {
        ...
        if(!worldObj.isRemote && this.tickCounter >= 22)
        {
        	PacketSendManagerServer.sendEntityData(this);
        	tickCounter = 2;
        }
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setByte("shake", (byte)this.crossbowBoltShake);
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        this.crossbowBoltShake = par1NBTTagCompound.getByte("shake") & 255;
    ...
    {
        if (!this.worldObj.isRemote && this.inGround && this.crossbowBoltShake <= 0)
        {
            boolean var2 = this.canBePickedUp == 1 || this.canBePickedUp == 2 && par1EntityPlayer.capabilities.isCreativeMode;

            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(IdMap.itemCraftingItems, 1, 10)))
            {
                var2 = false;
            }
    ...
    /**
     * Sets the amount of knockback the crossbowBolt applies when it hits a mob.
     */
    ...
    /**
     * Whether the crossbowBolt has a stream of critical hit particles flying behind it.
     */
